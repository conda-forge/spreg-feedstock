...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spreg-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3588&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spreg-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spreg` can be installed with:

```
conda install spreg
```

It is possible to list all of the versions of `spreg` available on your platform with:
